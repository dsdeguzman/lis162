  ...
  <body>
    <div class="py-3">
      <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <a href="/home/levels"><button type="button" class="btn btn-info btn-sm">Back to list of grade levels</button></a>
      </div>
    </div>
      ...
      <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
          <div class="p-6 bg-white border-b border-gray-200">
            <h5>Showing all current students in <strong>{{$student->level->grade_level}}</strong>.</h5>
          </div>
        </div>
      </div>
    </div>
      ...
      <table class="table table-hover table-bordered">
        ...
        <tbody>
          <tr class=details>
            ...
            <td style="padding-top:35px;">{{$student->section->section_name}}</td>
            <td style="padding-top:35px;">{{$student->adviser->adviser_full_name}}</td>
            <td>
